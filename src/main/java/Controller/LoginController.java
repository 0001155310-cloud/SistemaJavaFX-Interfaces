...
public class LoginController {
    ...
    public void initialize() {
        // Removido para evitar loop infinito e erro de localização
    }
    ...
    public void abrirAjuda() {
        ...
        alert.setContentText("Nome: Sistema de Reservas\nVersão: 1.0.0\nDesenvolvedor: Ryan Lucas Fernandes\nAno: 2026");
        alert.showAndWait();
    }

    private void carregarTela(String fxml) {
        try {
            // Usa o caminho absoluto garantindo que comece em resources/fxml/
